<?php
/* Copyright (C) 2025      Lenoble Arthur       <mapiolca@me.com>
 *
...
/**
 * \file       htdocs/core/boxes/waitingPropal.php
 * \ingroup    propales
 * \brief      Module to print unsigned propals
 */

include_once DOL_DOCUMENT_ROOT.'/core/boxes/modules_boxes.php';

/**
 * Class to manage the box to show oldest unsigned proposals
 */
class box_waitingPropal extends ModeleBoxes
{
	public $boxcode = "lastwaitingpropals";
	public $boximg = "object_waitingpropal";
	public $boxlabel = "Propal en attente de validation";
	...
	public function loadBox($max = 10)
	{
        ...
        $text = "Propales en attente de validation";
